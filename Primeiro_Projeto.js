...
if(a >= 4) {
    console.log(`${true} - A é maior que 4`); //Numa leitura básica, if(Se) a variável A for maior ou igual a 4 apresentar na tela o True.
) else {               //else (Se não) apresentar False na tela.
    console.log(`${false} - A é menor que 4`);
} 
